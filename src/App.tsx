...
const projectsData: Project[] = [
  {
    ...
    // githubLink: "https://github.com/ysukkar2?tab=repositories",
    // images: [
    //   "/images/12.jpeg", "/images/13.jpeg", "/images/14.jpeg", "/images/15.jpeg",
    //   "/images/16.jpeg", "/images/17.jpeg", "/images/18.jpeg", "/images/19.jpeg",
    //   "/images/20.jpeg", "/images/21.png"
    // ]
    
    images:[
    
      `${BASE_PATH}images/12.jpeg`, 
      `${BASE_PATH}images/13.jpeg`, 
      `${BASE_PATH}images/14.jpeg`, 
      `${BASE_PATH}images/15.jpeg`,
      `${BASE_PATH}images/16.jpeg`, 
      `${BASE_PATH}images/17.jpeg`, 
      `${BASE_PATH}images/18.jpeg`, 
      `${BASE_PATH}images/19.jpeg`,
      `${BASE_PATH}images/20.jpeg`, 
      `${BASE_PATH}images/21.png`
    ]
  },
  {
    id: 2,
    ...
    // githubLink: "https://github.com/ysukkar2?tab=repositories",
    //images: ["/images/real.png"]
    images: [`${BASE_PATH}images/real.png`]
  },

  {
    ...
    // ]
  images:[
    `${BASE_PATH}images/1.jpeg`, 
      `${BASE_PATH}images/2.jpeg`, 
      `${BASE_PATH}images/3.jpeg`, 
      `${BASE_PATH}images/4.jpeg`,
      `${BASE_PATH}images/5.jpeg`, 
      `${BASE_PATH}images/6.jpeg`, 
      `${BASE_PATH}images/7.jpeg`, 
      `${BASE_PATH}images/8.jpeg`,
      `${BASE_PATH}images/9.jpeg`, 
      `${BASE_PATH}images/10.jpeg`, 
      `${BASE_PATH}images/11.jpeg`
  ]
  }
    ...
    <div className="project-card">
      <div className="project-image-container">
        ...
        {!imageError ? (
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'center', height:'100%', color:'#666', width:'100%'}}>
            No Image Available
          </div>
        )}
